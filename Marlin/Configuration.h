...
#define STRING_CONFIG_H_AUTHOR "(LMO, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MMU 2.X"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5000, 5000, 100, 500 }
